package lesson19Practice.models;
...
public class Component {
    ...
    public <T extends Component> List<T> finComponents(Class<T> componentClass, WebDriver driver) {
    ...
    public <T extends Component> T findComponent(Class<T> componentClass, WebDriver driver){
        return finComponents(componentClass,driver).get(0);
    }
}
